...
namespace CleanArchitecture.Application.Features.Authentication.Handlers
{
...

    {
        ...
        public AuthenticationHandlerCommand(IUserRepository userRepository, SignInManager<User> signInManager, IAuthenticationService authenticationService, IEmailsService emailsService)
        {
        ...
        public async Task<Response<string>> Handle(SendResetPasswordCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                //string randNum = randam.Next(100000, 1000000).ToString();
